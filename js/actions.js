...
function executeAction(
    ...
    switch (actionName) {
        ...
        case "KillPlayer":
            ...
            if (!bloodWolfBypassesProtectionTonight && targets[0].armorCharges > 0) {
                targets[0].armorCharges--;
                targets[0].armorBrokeTonight = true;
                return true;
            }
        ...
        case "CopyRole": {
            ...
            if (!copiedPlayer.alive && !actor.doppelgangerInheritedRole) {
                ...
                inheritRoleState(actor, copiedPlayer);
                actor.isDoppelganger = true;
